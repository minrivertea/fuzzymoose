...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Price.out_of_stock'
        db.add_column(u'shop_price', 'out_of_stock',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Price.special_postage_price'
        db.add_column(u'shop_price', 'special_postage_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Price.out_of_stock'
        db.delete_column(u'shop_price', 'out_of_stock')

        # Deleting field 'Price.special_postage_price'
        db.delete_column(u'shop_price', 'special_postage_price')

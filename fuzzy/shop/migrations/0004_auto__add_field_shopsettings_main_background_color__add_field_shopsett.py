...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShopSettings.main_background_color'
        db.add_column(u'shop_shopsettings', 'main_background_color',
                      self.gf('paintstore.fields.ColorPickerField')(max_length=7, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShopSettings.footer_background_color'
        db.add_column(u'shop_shopsettings', 'footer_background_color',
                      self.gf('paintstore.fields.ColorPickerField')(max_length=7, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShopSettings.main_background_color'
        db.delete_column(u'shop_shopsettings', 'main_background_color')

        # Deleting field 'ShopSettings.footer_background_color'
        db.delete_column(u'shop_shopsettings', 'footer_background_color')

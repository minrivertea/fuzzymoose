...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.will_collect'
        db.add_column(u'shop_order', 'will_collect',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.will_collect'
        db.delete_column(u'shop_order', 'will_collect')
    ...
    models = {
        ...
        u'shop.basket': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 25, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'shop.basketitem': {
        ...
        u'shop.photo': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 25, 0, 0)'}),
        ...
        u'shop.review': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 25, 0, 0)'}),

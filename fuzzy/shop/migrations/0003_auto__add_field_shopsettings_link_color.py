...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShopSettings.link_color'
        db.add_column(u'shop_shopsettings', 'link_color',
                      self.gf('paintstore.fields.ColorPickerField')(max_length=7, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShopSettings.link_color'
        db.delete_column(u'shop_shopsettings', 'link_color')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShopSettings.logo'
        db.add_column(u'shop_shopsettings', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShopSettings.main_background_image'
        db.add_column(u'shop_shopsettings', 'main_background_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShopSettings.footer_background_image'
        db.add_column(u'shop_shopsettings', 'footer_background_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShopSettings.footer_logo'
        db.add_column(u'shop_shopsettings', 'footer_logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShopSettings.extra_css'
        db.add_column(u'shop_shopsettings', 'extra_css',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShopSettings.logo'
        db.delete_column(u'shop_shopsettings', 'logo')

        # Deleting field 'ShopSettings.main_background_image'
        db.delete_column(u'shop_shopsettings', 'main_background_image')

        # Deleting field 'ShopSettings.footer_background_image'
        db.delete_column(u'shop_shopsettings', 'footer_background_image')

        # Deleting field 'ShopSettings.footer_logo'
        db.delete_column(u'shop_shopsettings', 'footer_logo')

        # Deleting field 'ShopSettings.extra_css'
        db.delete_column(u'shop_shopsettings', 'extra_css')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'shop_product', 'is_featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ShopSettings.homepage_top_text'
        db.add_column(u'shop_shopsettings', 'homepage_top_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShopSettings.homepage_big_text'
        db.add_column(u'shop_shopsettings', 'homepage_big_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShopSettings.homepage_image'
        db.add_column(u'shop_shopsettings', 'homepage_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShopSettings.homepage_image_text'
        db.add_column(u'shop_shopsettings', 'homepage_image_text',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'shop_product', 'is_featured')

        # Deleting field 'ShopSettings.homepage_top_text'
        db.delete_column(u'shop_shopsettings', 'homepage_top_text')

        # Deleting field 'ShopSettings.homepage_big_text'
        db.delete_column(u'shop_shopsettings', 'homepage_big_text')

        # Deleting field 'ShopSettings.homepage_image'
        db.delete_column(u'shop_shopsettings', 'homepage_image')

        # Deleting field 'ShopSettings.homepage_image_text'
        db.delete_column(u'shop_shopsettings', 'homepage_image_text')
    ...
    models = {
        ...
        u'shop.basket': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 6, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'shop.basketitem': {
        ...
        u'shop.order': {
            ...
            'final_amount_paid': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'shopper': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['shop.Shopper']"}),
            'will_collect': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'shop.page': {
        ...
        u'shop.photo': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 6, 0, 0)'}),
        ...
        u'shop.review': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 6, 0, 0)'}),
        ...
        u'shop.shopsettings': {
            ...
            'homepage_big_text': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'homepage_browser_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'homepage_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'homepage_image_text': ('ckeditor.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}),
            'homepage_top_text': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

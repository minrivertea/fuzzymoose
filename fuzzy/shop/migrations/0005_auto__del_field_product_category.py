...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'shop_product', 'category_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'shop_product', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Category']),
                      keep_default=False)
    ...
    models = {
        ...
        u'shop.photo': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 8, 0, 0)'}),
        ...
        u'shop.review': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 8, 0, 0)'}),

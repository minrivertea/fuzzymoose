...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.mixed_box_number'
        db.add_column(u'shop_product', 'mixed_box_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.mixed_box_number'
        db.delete_column(u'shop_product', 'mixed_box_number')
    ...
    models = {
        ...
        u'shop.product': {
            ...
            'mixed_box_number': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),

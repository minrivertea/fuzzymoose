...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.preferred_delivery_date'
        db.add_column(u'shop_order', 'preferred_delivery_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.is_footer_link'
        db.add_column(u'shop_page', 'is_footer_link',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.preferred_delivery_date'
        db.delete_column(u'shop_order', 'preferred_delivery_date')

        # Deleting field 'Page.is_footer_link'
        db.delete_column(u'shop_page', 'is_footer_link')

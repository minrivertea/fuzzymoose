...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field mixed_box_choices on 'BasketItem'
        m2m_table_name = db.shorten_name(u'shop_basketitem_mixed_box_choices')
        ...
        db.create_unique(m2m_table_name, ['basketitem_id', 'product_id'])


    def backwards(self, orm):
        # Removing M2M table for field mixed_box_choices on 'BasketItem'
        db.delete_table(db.shorten_name(u'shop_basketitem_mixed_box_choices'))
    ...
    models = {
        ...
        u'shop.basket': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 7, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'shop.basketitem': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mixed_box_choices': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['shop.Product']", 'null': 'True', 'blank': 'True'}),
        ...
        u'shop.photo': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 7, 0, 0)'}),
        ...
        u'shop.product': {
            ...
            'meta_keywords': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'meta_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'mixed_box': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        u'shop.review': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 7, 0, 0)'}),
        ...
        u'shop.shopsettings': {
            ...
            'homepage_mugshot': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),

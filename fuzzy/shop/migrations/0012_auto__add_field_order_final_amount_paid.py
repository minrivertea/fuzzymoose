...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.final_amount_paid'
        db.add_column(u'shop_order', 'final_amount_paid',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.final_amount_paid'
        db.delete_column(u'shop_order', 'final_amount_paid')
    ...
    models = {
        ...
        u'shop.basket': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 29, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'shop.basketitem': {
        ...
        u'shop.photo': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 29, 0, 0)'}),
        ...
        u'shop.review': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 29, 0, 0)'}),

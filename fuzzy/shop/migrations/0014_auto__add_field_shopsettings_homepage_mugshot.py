...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShopSettings.homepage_mugshot'
        db.add_column(u'shop_shopsettings', 'homepage_mugshot',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShopSettings.homepage_mugshot'
        db.delete_column(u'shop_shopsettings', 'homepage_mugshot')
